...
async (param) => {
    ...
    const res = await axios.get(`${process.env.REACT_APP_AWS_API_GATEWAY}/get-customer-card-info?authorizer=${process.env.REACT_APP_AWS_API_KEY}&customer_id=${id}`, {headers: authHeaders});
